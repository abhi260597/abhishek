...
public class Main6Activity extends AppCompatActivity {
    ViewPager viewPager;
    Integer[]image={R.drawable.king1,R.drawable.king2,R.drawable.king3,R.drawable.king4};
    TextView m_response;
    static cart m_cart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            final Intent button1=new Intent(this,burger1.class);
        ...
        Button call_king = (Button) findViewById(R.id.call_king);


        call_king.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent king = new Intent(Intent.ACTION_CALL);
               king.setData(Uri.parse("tel:9811140804"));
    ...
    public class mypage extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            LayoutInflater layout = (LayoutInflater) Main6Activity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public class mytime extends TimerTask {
        @Override
        public void run() {
            Main6Activity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
