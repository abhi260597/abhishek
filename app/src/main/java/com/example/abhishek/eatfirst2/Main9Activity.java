...
public class Main9Activity extends AppCompatActivity {
    ...
    ViewPager viewPager;
    Integer[]image={R.drawable.taco1,R.drawable.taco2,R.drawable.taco3,R.drawable.taco4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            final Intent button1=new Intent(this,taco1.class);
            ...
            button.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    o=o+1;
                    if(o!=0){
                        nn=129*o+119*o1+199*o2+199*o3+299*o4+215*o5+305*o6+65*o7+30*o8;
        ...
        Button call_taco = (Button) findViewById(R.id.call_taco);


        call_taco.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent taco= new Intent(Intent.ACTION_CALL);
                taco.setData(Uri.parse("tel:9811140804"));
    ...
    public class mypage extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            LayoutInflater layout = (LayoutInflater) Main9Activity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public class mytime extends TimerTask {
        @Override
        public void run() {
            Main9Activity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
