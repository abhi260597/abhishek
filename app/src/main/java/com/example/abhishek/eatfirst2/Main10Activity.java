...
public class Main10Activity extends AppCompatActivity {
    ...
    ViewPager viewPager;
    Integer[]image={R.drawable.star1,R.drawable.star2,R.drawable.star3,R.drawable.star4};
    TextView m_response;
    static cart m_cart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            final Intent button1=new Intent(this,starbucks1.class);
            ...
            button.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    o=o+1;
                    if(o!=0){
                        nn=225*o+230*o1+220*o2+220*o3+180*o4+205*o5+165*o6+175*o7+200*o8;
        ...
        Button call_star= (Button) findViewById(R.id.call_star);


        call_star.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent star = new Intent(Intent.ACTION_CALL);
                star.setData(Uri.parse("tel:9811140804"));
    ...
    public class mypage extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            LayoutInflater layout = (LayoutInflater) Main10Activity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public class mytime extends TimerTask {
        @Override
        public void run() {
            Main10Activity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
