...
public class Main5Activity extends AppCompatActivity {
    ViewPager viewPager;
    Integer[]image={R.drawable.barb1,R.drawable.barb2,R.drawable.barb3,R.drawable.barb4};
    TextView m_response;
    static cart m_cart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button carttt=(Button)findViewById(R.id.barb);
        ...
        {
            final Intent button1=new Intent(this,barb1.class);
            ...
            button.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    o=o+1;
                    if(o!=0){
                        nn=325*o+250*o1+450*o2+499*o3+350*o4+650*o5+450*o6+300*o7+399*o8;
        ...
        final Button call_barb = (Button) findViewById(R.id.call_button1);


        call_barb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent barb = new Intent(Intent.ACTION_CALL);
                barb.setData(Uri.parse("tel:9811140804"));
    ...
    public class mypage extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            LayoutInflater layout = (LayoutInflater) Main5Activity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
