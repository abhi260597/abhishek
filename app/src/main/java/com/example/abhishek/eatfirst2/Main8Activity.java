...
public class Main8Activity extends AppCompatActivity {
    ...
    ViewPager viewPager;
    Integer[]image={R.drawable.chai1,R.drawable.chai2,R.drawable.chai3,R.drawable.chai4};
    TextView m_response;
    static cart m_cart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            final Intent button1=new Intent(this,chaayos1.class);
            ...
            button.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    o=o+1;
                    if(o!=0){
                        nn=139*o+119*o1+139*o2+278*o3+178*o4+198*o5+198*o6+278*o7+55*o8;
        ...
        Button call_chai= (Button) findViewById(R.id.call_chai);


        call_chai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent chai = new Intent(Intent.ACTION_CALL);
                chai.setData(Uri.parse("tel:9811140804"));
    ...
    public class mypage extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            LayoutInflater layout = (LayoutInflater) Main8Activity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public class mytime extends TimerTask {
        @Override
        public void run() {
            Main8Activity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
