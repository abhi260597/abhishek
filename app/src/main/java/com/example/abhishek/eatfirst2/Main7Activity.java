...
public class Main7Activity extends AppCompatActivity {
    ...
    ViewPager viewPager;
    Integer[]image={R.drawable.junk1,R.drawable.junk2,R.drawable.junk3,R.drawable.junk4};
    TextView m_response;
    static cart m_cart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            final Intent button1=new Intent(this,junk1.class);
            ...
            button.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    o=o+1;
                    if(o!=0){
                        nn=35*o+49*o1+65*o2+99*o3+109*o4+129*o5+89*o6+159*o7+269*o8;
            ...
            button2.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    o1=o1+1;
                    if(o1!=0){
                        nn=525*o+395*o1+325*o2+325*o3+345*o4+465*o5+425*o6+335*o7+595*o8;
                        m_response.setText(Integer.toString(nn));
        ...
        Button call_junk = (Button) findViewById(R.id.call_junk);


        call_junk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent junk = new Intent(Intent.ACTION_CALL);
               junk.setData(Uri.parse("tel:9811140804"));
    ...
    public class mypage extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            LayoutInflater layout = (LayoutInflater) Main7Activity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
